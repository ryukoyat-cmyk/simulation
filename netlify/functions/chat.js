...
export default async (req) => {
  ...
  try {
    ...
    const raw = await createWithFallback({ model: process.env.OPENAI_CHAT_MODEL || "gpt-4o-mini", system, input, maxOutputTokens: body.maxTokens || 1200, responseFormat }, "gpt-4.1-mini");
